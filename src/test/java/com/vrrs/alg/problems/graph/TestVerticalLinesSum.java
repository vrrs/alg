...
public class TestVerticalLinesSum {
	
	@Test
	public void willComputeVerticalSums() {
		int[] verticalLinesSum = new VerticalLinesSum().getVerticalLinesSum(getRootOfIntTree());
		assertThat(verticalLinesSum).containsExactly(20, 30, 150, 70, 80);
	}
